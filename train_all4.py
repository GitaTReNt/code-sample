...
from args_SGNN import get_args
from collections import OrderedDict
from json import dumps
# from model.model_readout4 import DCRNN_readout_classification
# from model.model_attention import DCRNN_attention_classification
from model.model_all4 import DCRNN_all_classification, DCRNNModel_nextTimePred
...
def main(args):
    ...
    if args.model_name == "dcrnn_all":
        model = DCRNN_all_classification(
            args=args, num_classes=args.num_classes, device=device)
    # elif args.model_name == "dcrnn_attention":
    #     model = DCRNN_attention_classification(
    #         args=args, num_classes=args.num_classes, device=device)
    # elif args.model_name == "dcrnn_readout":
    #     model = DCRNN_readout_classification(
    #         args=args, num_classes=args.num_classes, device=device)
